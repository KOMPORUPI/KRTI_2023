...
def simple_demo():
    ...
    while not rospy.is_shutdown():
        ...
        if c.is_balance() and c.is_center() == "0":
            ...
            if c.is_center == "kanan":
                c.rc_override_msg.channels[0] = ROLL_OVERRIDE_SLOW[1]
            elif c.is_center == "kiri":
                c.rc_override_msg.channels[0] = ROLL_OVERRIDE_SLOW[0]
            elif c.is_center == "0":
                c.rc_override_msg.channels[0] = ROLL_OVERRIDE_IDLE[0]
